...
public class Kuis1 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        txtno = (TextView) findViewById(R.id.textViewHal);
    ...
    private void setUpWaktu() {
        mCountDownTimer = new CountDownTimer(detik, 1000)
        {
            ...
            public void onFinish()
            {
                ...
                Toast.makeText(Kuis1.this, "Waktu Habis",
    ...
    private OnClickListener klikSelesai = new OnClickListener() {
        public void onClick(View v) {
            ...
            tampilKotakAlert = new AlertDialog.Builder(Kuis1.this).create();
            ...
            tampilKotakAlert.setButton(AlertDialog.BUTTON_NEUTRAL, "Lagi",
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Kuis1.this.tunjukanPertanyaan(0,
                                    cekPertanyaan);
                        }
                    });
